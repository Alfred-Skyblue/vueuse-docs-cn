import{_ as s,o as n,c as a,g as l}from"./app.edc7c100.js";const A=JSON.parse('{"title":"syncRefs","description":"","frontmatter":{},"headers":[],"relativePath":"functions/reactivity/syncRefs/index.md","lastUpdated":1677756257000}'),p={name:"functions/reactivity/syncRefs/index.md"},o=l(`<h1 id="syncrefs" tabindex="-1">syncRefs <a class="header-anchor" href="#syncrefs" aria-hidden="true">#</a></h1><p>保持目标引用与源引用同步</p><h2 id="用法" tabindex="-1">用法 <a class="header-anchor" href="#用法" aria-hidden="true">#</a></h2><div class="language-ts"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki github-dark vp-code-dark" tabindex="0"><code><span class="line"><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> { syncRefs } </span><span style="color:#F97583;">from</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">&#39;@vueuse/core&#39;</span></span>
