import{_ as s,o as n,c as a,g as p}from"./app.45f58b8a.js";const D=JSON.parse('{"title":"useScriptTag","description":"","frontmatter":{},"headers":[],"relativePath":"functions/browser/useScriptTag/index.md","lastUpdated":1677744348000}'),l={name:"functions/browser/useScriptTag/index.md"},o=p(`<h1 id="usescripttag" tabindex="-1">useScriptTag <a class="header-anchor" href="#usescripttag" aria-hidden="true">#</a></h1><p>注入 script 标签。</p><h2 id="用法" tabindex="-1">用法 <a class="header-anchor" href="#用法" aria-hidden="true">#</a></h2><div class="language-ts"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki github-dark vp-code-dark" tabindex="0"><code><span class="line"><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> { useScriptTag } </span><span style="color:#F97583;">from</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">&#39;@vueuse/core&#39;</span></span>
