import{_ as s,o as n,c as a,g as l}from"./app.b382afd7.js";const g=JSON.parse('{"title":"组件","description":"","frontmatter":{},"headers":[],"relativePath":"guide/components.md","lastUpdated":1677736325000}'),p={name:"guide/components.md"},o=l(`<h1 id="组件" tabindex="-1">组件 <a class="header-anchor" href="#组件" aria-hidden="true">#</a></h1><p>在 v5.0 中，我们引入了一个新包，<code>@vueuse/components</code> 提供可组合函数的无渲染组件版本。</p><h2 id="安装" tabindex="-1">安装 <a class="header-anchor" href="#安装" aria-hidden="true">#</a></h2><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki github-dark vp-code-dark" tabindex="0"><code><span class="line"><span style="color:#B392F0;">npm</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">i</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">@vueuse/functions</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">@vueuse/components</span></span>
...
<span class="line"></span></code></pre></div>`,13),e=[o];function t(c,r,E,y,i,d){return n(),a("div",null,e)}const F=s(p,[["render",t]]);export{g as __pageData,F as default};
