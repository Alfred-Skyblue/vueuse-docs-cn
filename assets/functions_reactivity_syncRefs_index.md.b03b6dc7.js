import{_ as n,o as a,c as l,a as p}from"./app.a0e03023.js";const F=JSON.parse('{"title":"syncRefs","description":"","frontmatter":{},"headers":[],"relativePath":"functions/reactivity/syncRefs/index.md","lastUpdated":1743581019000}'),o={name:"functions/reactivity/syncRefs/index.md"};function e(c,s,t,r,y,E){return a(),l("div",null,s[0]||(s[0]=[p(`<h1 id="syncrefs" tabindex="-1">syncRefs <a class="header-anchor" href="#syncrefs" aria-hidden="true">#</a></h1><p>保持目标引用与源引用同步</p><h2 id="用法" tabindex="-1">用法 <a class="header-anchor" href="#用法" aria-hidden="true">#</a></h2><div class="language-ts"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki github-dark vp-code-dark" tabindex="0"><code><span class="line"><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> { syncRefs } </span><span style="color:#F97583;">from</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">&#39;@vueuse/core&#39;</span></span>
...
<span class="line"></span></code></pre></div>`,8)]))}const u=n(o,[["render",e]]);export{F as __pageData,u as default};
